...
class AmbulanceMaintenancePage extends StatefulWidget {
  const AmbulanceMaintenancePage({super.key});

  @override
  State<AmbulanceMaintenancePage> createState() => _AmbulanceMaintenancePageState();
}

class _AmbulanceMaintenancePageState extends State<AmbulanceMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load ambulance maintenance schedule.\n$error",
