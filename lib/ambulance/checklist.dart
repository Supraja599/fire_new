...
class AmbulanceChecklistPage extends StatefulWidget {
  ...
  const AmbulanceChecklistPage({super.key, this.selectedEquipment});
  @override
...
class _AmbulanceChecklistPageState extends State<AmbulanceChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Ambulance Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
