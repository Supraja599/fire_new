...
import 'package:fire_new/planthealth.dart';
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  "Real-time health surveillance, compliance logging, and operational readiness telemetry for all deployed ${"Extinguisher"} systems.",
                  style: TextStyle(
                    fontSize: 12.5,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Extinguisher Analytics".toUpperCase(),
          style: const TextStyle(
            color: Color(0xFFD50000),
            fontWeight: FontWeight.w900,
            fontSize: 16,
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const PlantHealthPage(),
                  ),
                );
              },
              child: Container(
