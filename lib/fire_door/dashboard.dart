...
class FireDoorDashboard extends StatefulWidget {
  const FireDoorDashboard({super.key});

  @override
  State<FireDoorDashboard> createState() => _FireDoorDashboardState();
}

class _FireDoorDashboardState extends State<FireDoorDashboard> {
        ...
        child: ListView(
          ...
          children: [
                  ...
                  const Expanded(
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text("Fire Door", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                      ),
                    ),
                  ),
                  Container(
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        FittedBox(
                          fit: BoxFit.scaleDown,
                          child: Text("Structural Integrity", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900, height: 1.2)),
                        ),
                        SizedBox(height: 12),
                  ...
                  Image.asset('assets/fire_door.png', height: 110, fit: BoxFit.contain, errorBuilder: (c, e, s) => const Icon(Icons.door_front_door, color: Colors.white, size: 80)),
                ],
              ),
            ),
            ...
            GridView.count(
              ...
              children: [
                _ActionCard("Plant Health", Icons.analytics_outlined, Colors.green, const FireDoorPlantHealthPage(), "Device Health"),
                _ActionCard("Alerts", Icons.notification_important_outlined, Colors.red, const FireDoorAlertsPage(), "Safety Alerts"),
                _ActionCard("Maintenance", Icons.build_circle_outlined, Colors.orange, const FireDoorMaintenancePage(), "Services"),
                _ActionCard("Reports", Icons.summarize_outlined, Colors.purple, const FireDoorReportsPage(), "History"),
                _ActionCard("Checklist", Icons.fact_check_outlined, Colors.teal, const FireDoorChecklistPage(), "Forms"),
                _ActionCard("Inspection", Icons.camera_enhance_outlined, Colors.blue, const FireDoorScanPage(), "Scan"),
              ],
            ),
