...
class FireDoorChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const FireDoorChecklistPage({super.key, this.selectedEquipment});
  @override
  State<FireDoorChecklistPage> createState() => _FireDoorChecklistPageState();
}

class _FireDoorChecklistPageState extends State<FireDoorChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Fire Door Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
