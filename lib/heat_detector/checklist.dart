...
class HeatDetectorChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const HeatDetectorChecklistPage({super.key, this.selectedEquipment});
  @override
  State<HeatDetectorChecklistPage> createState() => _HeatDetectorChecklistPageState();
}

class _HeatDetectorChecklistPageState extends State<HeatDetectorChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Heat Detector Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
