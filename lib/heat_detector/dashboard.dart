            ...
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    const Column(
                      ...
                      children: [
                        Text("Heat Detector", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color(0xFFB71C1C))),
              ...
              child: Row(
                children: [
                  ...
                  Image.asset('assets/heat_detector.png', height: 95, fit: BoxFit.contain, errorBuilder: (c, e, s) => const Icon(Icons.medical_services, color: Colors.white, size: 70)),
                ],
              ),
              ),
