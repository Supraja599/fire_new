                  ...
                  const Expanded(
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text("Heat Detector", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                      ),
                    ),
                  ),
                  Container(
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        FittedBox(
                          fit: BoxFit.scaleDown,
                          child: Text("Thermal Safety Network", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900, height: 1.2)),
                        ),
                        SizedBox(height: 12),
                  ...
                  Image.asset('assets/heat_detector.png', height: 110, fit: BoxFit.contain, errorBuilder: (c, e, s) => const Icon(Icons.hot_tub, color: Colors.white, size: 80)),
                ],
              ),
            ),
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                return GridView.count(
                  ...
                  children: [
                    _ActionCard("Plant Health", Icons.analytics_outlined, Colors.green, const HeatDetectorPlantHealthPage(), "Device Health"),
                    _ActionCard("Alerts", Icons.notification_important_outlined, Colors.red, const HeatDetectorAlertsPage(), "Safety Alerts"),
                    _ActionCard("Maintenance", Icons.build_circle_outlined, Colors.orange, const HeatDetectorMaintenancePage(), "Services"),
                    _ActionCard("Reports", Icons.summarize_outlined, Colors.purple, const HeatDetectorReportsPage(), "History"),
                    _ActionCard("Checklist", Icons.fact_check_outlined, Colors.teal, const HeatDetectorChecklistPage(), "Forms"),
                    _ActionCard("Inspection", Icons.camera_enhance_outlined, Colors.blue, const HeatDetectorScanPage(), "Scan"),
                  ],
                );
              },
            ),
