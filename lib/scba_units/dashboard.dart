      ...
      body: SafeArea(
        child: Column(children: [
          Padding(padding: const EdgeInsets.all(20), child: Row(children: [
            ...
            const Spacer(),
            Text("SCBA Units", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
            const Spacer(),
            ...
            child: Column(children: [
              Row(children: [
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text("SCBA Units System", style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color(0xFF0D47A1), height: 1.1)),
                ])),
                Image.asset("assets/scba_unit.png", height: 80, fit: BoxFit.contain, errorBuilder: (c,e,s) => Icon(Icons.air, size: 70, color: primary)),
              ]),
