...
class SCBAUnitsDashboard extends StatefulWidget {
  const SCBAUnitsDashboard({super.key});
  @override
  State<SCBAUnitsDashboard> createState() => _SCBAUnitsDashboardState();
}

class _SCBAUnitsDashboardState extends State<SCBAUnitsDashboard> {
              ...
              const Expanded(
                child: Center(
                  child: FittedBox(
                    ...
                    child: Text("SCBA Units", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                  ),
                ),
              ),
              ...
              child: Column(children: [
                Row(children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    FittedBox(
                      fit: BoxFit.scaleDown,
                      child: Text("SCBA Units System", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Color(0xFF0D47A1), height: 1.1)),
                    ),
                  ])),
                  const SizedBox(width: 10),
                  Image.asset("assets/scba_unit.png", height: 70, fit: BoxFit.contain, errorBuilder: (c,e,s) => const Icon(Icons.air, size: 50, color: primary)),
                ]),
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                return GridView.count(
                  ...
                  children: [
                    _Card("Plant Health", Icons.analytics_outlined, const SCBAUnitsPlantHealthPage(), Colors.green.shade600, "Device Health"),
                    _Card("Safety Alerts", Icons.notification_important_outlined, const SCBAUnitsAlertsPage(), Colors.red.shade600, "Active Alerts"),
                    _Card("Maintenance", Icons.build_circle_outlined, const SCBAUnitsMaintenancePage(), Colors.orange.shade700, "Services"),
                    _Card("Reports", Icons.summarize_outlined, const SCBAUnitsReportsPage(), Colors.purple.shade600, "History"),
                    _Card("Checklist", Icons.fact_check_outlined, const SCBAUnitsChecklistPage(), Colors.teal.shade700, "Forms"),
                    _Card("Inspection", Icons.qr_code_scanner, const SCBAUnitsScanPage(), Colors.blue.shade700, "Search"),
                  ],
                );
              },
            ),
