...
class SCBAUnitsChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const SCBAUnitsChecklistPage({super.key, this.selectedEquipment});
  @override
  State<SCBAUnitsChecklistPage> createState() => _SCBAUnitsChecklistPageState();
}

class _SCBAUnitsChecklistPageState extends State<SCBAUnitsChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("SCBA Units Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
