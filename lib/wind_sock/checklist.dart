...
class WindSockChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const WindSockChecklistPage({super.key, this.selectedEquipment});
  @override
  State<WindSockChecklistPage> createState() => _WindSockChecklistPageState();
}

class _WindSockChecklistPageState extends State<WindSockChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Wind Sock Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
