...
class WindSockAlertsPage extends StatefulWidget {
  ...
  @override
  State<WindSockAlertsPage> createState() => _WindSockAlertsPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading ? const Center(child: CircularProgressIndicator()) : alerts.isEmpty ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset("assets/wind_sock.png", height: 120, opacity: const AlwaysStoppedAnimation(0.3), errorBuilder: (c,e,s) => Icon(Icons.flag, size: 100, color: Colors.grey.shade300)),
