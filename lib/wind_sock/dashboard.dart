              ...
              const Expanded(
                child: Center(
                  child: FittedBox(
                    ...
                    child: Text("Wind Sock", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                  ),
                ),
              ),
              ...
              child: Column(children: [
                Row(children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    FittedBox(
                      fit: BoxFit.scaleDown,
                      child: Text("Wind Sock System", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Color(0xFF0D47A1), height: 1.1)),
                    ),
                  ])),
                  const SizedBox(width: 10),
                  Image.asset("assets/wind_sock.png", height: 70, fit: BoxFit.contain, errorBuilder: (c,e,s) => const Icon(Icons.flag, size: 50, color: primary)),
                ]),
