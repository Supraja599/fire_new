...
class ChemicalShowerMaintenancePage extends StatefulWidget {
  const ChemicalShowerMaintenancePage({super.key});

  @override
  State<ChemicalShowerMaintenancePage> createState() => _ChemicalShowerMaintenancePageState();
}

class _ChemicalShowerMaintenancePageState extends State<ChemicalShowerMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load chemical shower maintenance schedule.\n$error",
