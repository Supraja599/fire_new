...
class ChemicalShowerChecklistPage extends StatefulWidget {
  const ChemicalShowerChecklistPage({super.key});
  @override
  State<ChemicalShowerChecklistPage> createState() => _ChemicalShowerChecklistPageState();
}

class _ChemicalShowerChecklistPageState extends State<ChemicalShowerChecklistPage> {
  ...
  void _save() async {
    ...
    await LocalDB.queueModuleInspection(
      ...
      moduleCode: ChemicalShowerApiService.moduleCode,
      equipmentId: eq,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Chemical Shower Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
