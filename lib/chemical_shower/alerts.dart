...
class ChemicalShowerAlertsPage extends StatefulWidget {
  const ChemicalShowerAlertsPage({super.key});
  @override
  State<ChemicalShowerAlertsPage> createState() => _ChemicalShowerAlertsPageState();
}

class _ChemicalShowerAlertsPageState extends State<ChemicalShowerAlertsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading ? const Center(child: CircularProgressIndicator()) : alerts.isEmpty ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset("assets/chemical_shower.png", height: 120, opacity: const AlwaysStoppedAnimation(0.3), errorBuilder: (c,e,s) => Icon(Icons.medical_services, size: 100, color: Colors.grey.shade300)),
