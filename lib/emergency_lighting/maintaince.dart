...
class EmergencyLightingMaintenancePage extends StatefulWidget {
  const EmergencyLightingMaintenancePage({super.key});

  @override
  State<EmergencyLightingMaintenancePage> createState() => _EmergencyLightingMaintenancePageState();
}

class _EmergencyLightingMaintenancePageState extends State<EmergencyLightingMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load emergency lighting maintenance schedule.\n$error",
