...
class EmergencyLightingChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const EmergencyLightingChecklistPage({super.key, this.selectedEquipment});
  @override
  State<EmergencyLightingChecklistPage> createState() => _EmergencyLightingChecklistPageState();
}

class _EmergencyLightingChecklistPageState extends State<EmergencyLightingChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Emergency Lighting Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
