              ...
              const Expanded(
                child: Center(
                  child: FittedBox(
                    ...
                    child: Text("Emergency Exits", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                  ),
                ),
              ),
              ...
              child: Column(children: [
                Row(children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    FittedBox(
                      fit: BoxFit.scaleDown,
                      child: Text("Emergency Exits System", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Color(0xFF0D47A1), height: 1.1)),
                    ),
                  ])),
                  const SizedBox(width: 10),
                  Image.asset("assets/emergency_exit.png", height: 70, fit: BoxFit.contain, errorBuilder: (c,e,s) => const Icon(Icons.door_front_door, size: 50, color: primary)),
                ]),
