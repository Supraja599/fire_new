              ...
              builder: (context, constraints) {
                ...
                return Padding(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.png", const Color(0xFFD32F2F), const EmergencyExitsPlantHealthPage(), "Score"),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.png", const Color(0xFFD32F2F), const EmergencyExitsAlertsPage(), "Critical"),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.png", const Color(0xFFD32F2F), const EmergencyExitsMaintenancePage(), "Service"),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.png", const Color(0xFFD32F2F), const EmergencyExitsReportsPage(), "Logs"),
                      _ActionCard("Checklist", Icons.library_books_rounded, const Color(0xFFD32F2F), const EmergencyExitsChecklistPage(), "Forms"),
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.png", const Color(0xFFD32F2F), const EmergencyExitsScanPage(), "Scan"),
                    ],
                  ),
                );
              },
