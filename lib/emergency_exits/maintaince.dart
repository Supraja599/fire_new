...
class EmergencyExitsMaintenancePage extends StatefulWidget {
  const EmergencyExitsMaintenancePage({super.key});

  @override
  State<EmergencyExitsMaintenancePage> createState() => _EmergencyExitsMaintenancePageState();
}

class _EmergencyExitsMaintenancePageState extends State<EmergencyExitsMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load emergency exits maintenance schedule.\n$error",
