...
class EmergencyExitsScanPage extends StatefulWidget {
  ...
  @override
  State<EmergencyExitsScanPage> createState() => _EmergencyExitsScanPageState();
}
...
class _EmergencyExitsScanPageState extends State<EmergencyExitsScanPage> {
  ...
  Future<void> _fetchDetails(String code) async {
    ...
    if (res == null) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("No equipment found with this ID")));
    }
  }
