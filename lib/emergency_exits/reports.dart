  ...
  Future<void> generatePDF() async {
    ...
    try {
      ...
      pdf.addPage(pw.MultiPage(
        build: (context) => [
          pw.Header(level: 0, child: pw.Text("EMERGENCY EXIT SAFETY REPORT", style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold))),
            ...
            child: Padding(
              ...
              child: Column(children: [
                DropdownButtonFormField<String>(
                  value: selectedPlant,
                  isExpanded: true,
                  items: ["Emergency Exits", "Emergency Lighting", "PA System"].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
