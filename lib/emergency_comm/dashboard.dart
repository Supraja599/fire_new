            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  const Text("Emergency Comm", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                  const Spacer(),
                  Container(
                  ...
                  Row(
                    children: [
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Communication\nNetworks",
                              style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: textDark, height: 1.1),
                            ),
                          ],
                        ),
                      ),
                      Image.asset(
                        ...
                        height: 80,
                        fit: BoxFit.contain,
                        errorBuilder: (c, e, s) => const Icon(Icons.cell_tower, color: primary, size: 60),
                      ),
                    ],
                  ),
