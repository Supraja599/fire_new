...
class EmergencyCommDashboard extends StatefulWidget {
  const EmergencyCommDashboard({super.key});

  @override
  State<EmergencyCommDashboard> createState() => _EmergencyCommDashboardState();
}

class _EmergencyCommDashboardState extends State<EmergencyCommDashboard> {
  static const Color primary = Color(0xFF303F9F);
  static const Color accent = Color(0xFFC5CAE9);
          ...
          children: [
                  ...
                  const Expanded(
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text("Emergency Comm", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                      ),
                    ),
                  ),
                  Container(
                  ...
                  Row(
                    children: [
                      ...
                      Image.asset(
                        ...
                        height: 70,
                        fit: BoxFit.contain,
                        errorBuilder: (c, e, s) => const Icon(Icons.cell_tower, color: primary, size: 50),
                      ),
                    ],
                  ),
            ...
            // BIG ACTION CARDS (2x3 GRID)
             GridView.count(
                ...
                children: [
                  _BigActionCard("Plant Health", Icons.analytics_outlined, const EmergencyCommPlantHealthPage(), Colors.green.shade600, "Device Health"),
                  _BigActionCard("Safety Alerts", Icons.notification_important_outlined, const EmergencyCommAlertsPage(), Colors.red.shade600, "Active Alerts"),
                  _BigActionCard("Maintenance", Icons.build_circle_outlined, const EmergencyCommMaintenancePage(), Colors.orange.shade700, "Services"),
                  _BigActionCard("Reports", Icons.summarize_outlined, const EmergencyCommReportsPage(), Colors.purple.shade600, "History"),
                  _BigActionCard("Checklist", Icons.fact_check_outlined, const EmergencyCommChecklistPage(), Colors.teal.shade700, "Forms"),
                  _BigActionCard("Inspection", Icons.camera_enhance_outlined, const EmergencyCommScanPage(), Colors.blue.shade700, "Scan"),
                ],
              ),
            ...
            Column(
              ...
              children: [
                FittedBox(
                  ...
                  child: Text(
                    title,
                    style: const TextStyle(fontWeight: FontWeight.w900, color: Color(0xFF1A237E), fontSize: 14),
                  ),
                ),
