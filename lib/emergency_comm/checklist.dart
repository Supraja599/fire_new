...
class EmergencyCommChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const EmergencyCommChecklistPage({super.key, this.selectedEquipment});
  @override
  State<EmergencyCommChecklistPage> createState() => _EmergencyCommChecklistPageState();
}

class _EmergencyCommChecklistPageState extends State<EmergencyCommChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Emergency Comm Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
