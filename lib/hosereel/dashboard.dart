                  ...
                  const Expanded(
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text("Hose Reel", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                      ),
                    ),
                  ),
                  Container(
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        FittedBox(
                          fit: BoxFit.scaleDown,
                          child: Text("Pressure Monitoring", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900, height: 1.2)),
                        ),
                        SizedBox(height: 12),
                        Text("Central reel control.", style: TextStyle(color: Colors.white60, fontSize: 13)),
                      ],
                    ),
                  ),
