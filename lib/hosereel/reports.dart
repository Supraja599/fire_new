...
class _HoseReelReportsPageState extends State<HoseReelReportsPage> {
  ...
  Future<void> generatePDF() async {
    ...
    try {
      ...
      final file = File("${dir.path}/HoseReel_Report_${DateTime.now().millisecondsSinceEpoch}.pdf");
  ...
  Future<void> downloadExcel() async {
    ...
    try {
      ...
      String path = "${dir.path}/HoseReel_Report_${DateTime.now().millisecondsSinceEpoch}.xlsx";
      File file = File(path);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Hose Reel Reports"),
                ...
                child: Column(
                  children: [
                    DropdownButtonFormField<String>(
                      value: selectedPlant,
                      isExpanded: true,
                      items: ["Hose Reels"].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
