...
class SignageScanPage extends StatefulWidget {
  const SignageScanPage({super.key});
  @override
  State<SignageScanPage> createState() => _SignageScanPageState();
}

class _SignageScanPageState extends State<SignageScanPage> {
    ...
    showDialog(context: context, builder: (c) => AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.red), onPressed: () async {
          ...
          await LocalDB.saveSingleModuleRecord(moduleCode: SignageApiService.moduleCode, recordType: "equipment", item: item!);
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton.icon(
          ...
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => SignageChecklistPage(selectedEquipment: item))),
        ),
      ),
    );
  }
