...
class SignageMaintenancePage extends StatefulWidget {
  const SignageMaintenancePage({super.key});

  @override
  State<SignageMaintenancePage> createState() => _SignageMaintenancePageState();
}

class _SignageMaintenancePageState extends State<SignageMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load signage maintenance schedule.\n$error",
