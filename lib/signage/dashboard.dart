                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Hero(
                        tag: "hero_image_assets/signage.webp",
                        child: Image.asset(
                          "assets/signage.webp",
                          width: 130,
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _ActionCard("Analytics", "assets/dashboard_icons/analytics.webp", const Color(0xFFD32F2F), GenericAnalyticsPage(
                        title: "Signage Analytics",
                        shortName: "Signage",
                        assetLabel: "TOTAL SIGNAGE",
                        apiService: api,
                        imagePath: "assets/signage.webp",
                        fallbackIcon: Icons.analytics_rounded,
                      ), "Trends", _loadData),
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.webp", const Color(0xFFD32F2F), const SignageInspectionPage(), "Scan", _loadData),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.webp", const Color(0xFFD32F2F), const SignageMaintenancePage(), "Service", _loadData),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.webp", const Color(0xFFD32F2F), const SignageAlertsPage(), "Critical", _loadData),
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.webp", const Color(0xFFD32F2F), GenericPlantHealthPage(
                        title: "Signage Health",
                        shortName: "Signage",
                        apiService: api,
                        imagePath: "assets/signage.webp",
                        fallbackIcon: Icons.health_and_safety_rounded,
                      ), "Score", _loadData),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.webp", const Color(0xFFD32F2F), const SignageReportsPage(), "Logs", _loadData),
                    ],
                  ),
                );
              },
