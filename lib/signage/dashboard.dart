...
class SignageDashboard extends StatefulWidget {
  const SignageDashboard({super.key});

  @override
  State<SignageDashboard> createState() => _SignageDashboardState();
}

class _SignageDashboardState extends State<SignageDashboard> {
  static const Color primary = Color(0xFF512DA8);
  static const Color accent = Color(0xFFD1C4E9);
  static const Color textDark = Color(0xFF311B92);
          ...
          children: [
                  ...
                  const Expanded(
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text("Signage", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                      ),
                    ),
                  ),
                  Container(
                  ...
                  Row(
                    children: [
                      ...
                      Image.asset(
                        ...
                        height: 70,
                        fit: BoxFit.contain,
                        errorBuilder: (c, e, s) => const Icon(Icons.directions, color: primary, size: 50),
                      ),
                    ],
                  ),
            ...
            // BIG ACTION CARDS (2x3 GRID)
             GridView.count(
                ...
                children: [
                  _BigActionCard("Plant Health", Icons.analytics_outlined, const SignagePlantHealthPage(), Colors.green.shade600, "Device Health"),
                  _BigActionCard("Safety Alerts", Icons.notification_important_outlined, const SignageAlertsPage(), Colors.red.shade600, "Active Alerts"),
                  _BigActionCard("Maintenance", Icons.build_circle_outlined, const SignageMaintenancePage(), Colors.orange.shade700, "Services"),
                  _BigActionCard("Reports", Icons.summarize_outlined, const SignageReportsPage(), Colors.purple.shade600, "History"),
                  _BigActionCard("Checklist", Icons.fact_check_outlined, const SignageChecklistPage(), Colors.teal.shade700, "Forms"),
                  _BigActionCard("Inspection", Icons.camera_enhance_outlined, const SignageScanPage(), Colors.blue.shade700, "Scan"),
                ],
              ),
            ...
            Column(
              ...
              children: [
                FittedBox(
                  ...
                  child: Text(
                    title,
                    style: const TextStyle(fontWeight: FontWeight.w900, color: Color(0xFF311B92), fontSize: 14),
                  ),
                ),
