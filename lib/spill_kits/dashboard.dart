...
class SpillKitsDashboard extends StatefulWidget {
  const SpillKitsDashboard({super.key});

  @override
  State<SpillKitsDashboard> createState() => _SpillKitsDashboardState();
}

class _SpillKitsDashboardState extends State<SpillKitsDashboard> {
  static const Color primary = Color(0xFF33691E);
  static const Color accent = Color(0xFFDCEDC8);
              ...
              builder: (context, constraints) {
                ...
                return Padding(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.png", const Color(0xFFD32F2F), const SpillKitsPlantHealthPage(), "Score"),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.png", const Color(0xFFD32F2F), const SpillKitsAlertsPage(), "Critical"),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.png", const Color(0xFFD32F2F), const SpillKitsMaintenancePage(), "Service"),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.png", const Color(0xFFD32F2F), const SpillKitsReportsPage(), "Logs"),
                      _ActionCard("Checklist", Icons.library_books_rounded, const Color(0xFFD32F2F), const SpillKitsChecklistPage(), "Forms"),
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.png", const Color(0xFFD32F2F), const SpillKitsScanPage(), "Scan"),
                    ],
                  ),
                );
              },
