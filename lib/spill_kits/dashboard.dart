                  ...
                  const Expanded(
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text("Spill Kits", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                      ),
                    ),
                  ),
                  Container(
                  ...
                  Row(
                    children: [
                      ...
                      Image.asset(
                        ...
                        height: 70,
                        fit: BoxFit.contain,
                        errorBuilder: (c, e, s) => const Icon(Icons.water_drop, color: primary, size: 50),
                      ),
                    ],
                  ),
            ...
            Column(
              ...
              children: [
                FittedBox(
                  ...
                  child: Text(
                    title,
                    style: const TextStyle(fontWeight: FontWeight.w900, color: Color(0xFF1B5E20), fontSize: 14),
                  ),
                ),
