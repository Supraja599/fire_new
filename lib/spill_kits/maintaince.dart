...
class SpillKitsMaintenancePage extends StatefulWidget {
  const SpillKitsMaintenancePage({super.key});

  @override
  State<SpillKitsMaintenancePage> createState() => _SpillKitsMaintenancePageState();
}

class _SpillKitsMaintenancePageState extends State<SpillKitsMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load spill kits maintenance schedule.\n$error",
