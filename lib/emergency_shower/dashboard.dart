...
class _EmergencyShowerDashboardState extends State<EmergencyShowerDashboard> {
  ...
  final api = ModuleApiService.safetyShower;
  bool isLoading = true;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Hero(
                        tag: "hero_image_assets/emergency_shower.webp",
                        child: Image.asset(
                ...
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Emergency Shower Intelligence Hub",
                          style: TextStyle(
                            fontSize: 13.5,
                            fontWeight: FontWeight.w900,
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _ActionCard("Analytics", "assets/dashboard_icons/analytics.webp", const Color(0xFFD32F2F), GenericAnalyticsPage(
                        title: "Emergency Shower Analytics",
                        shortName: "Emergency Shower",
                        assetLabel: "TOTAL EMERGENCY SHOWER",
                        apiService: api,
                        imagePath: "assets/emergency_shower.webp",
                        fallbackIcon: Icons.analytics_rounded,
                      ), "Trends", _loadData),
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.webp", const Color(0xFFD32F2F), const EmergencyShowerInspectionPage(), "Scan", _loadData),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.webp", const Color(0xFFD32F2F), const EmergencyShowerMaintenancePage(), "Service", _loadData),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.webp", const Color(0xFFD32F2F), const EmergencyShowerAlertsPage(), "Critical", _loadData),
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.webp", const Color(0xFFD32F2F), GenericPlantHealthPage(
                        title: "Emergency Shower Health",
                        shortName: "Emergency Shower",
                        apiService: api,
                        imagePath: "assets/emergency_shower.webp",
                        fallbackIcon: Icons.health_and_safety_rounded,
                      ), "Score", _loadData),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.webp", const Color(0xFFD32F2F), const EmergencyShowerReportsPage(), "Logs", _loadData),
                    ],
                  ),
                );
              },
