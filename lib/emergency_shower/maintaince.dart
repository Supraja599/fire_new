...
class EmergencyShowerMaintenancePage extends StatefulWidget {
  const EmergencyShowerMaintenancePage({super.key});

  @override
  State<EmergencyShowerMaintenancePage> createState() => _EmergencyShowerMaintenancePageState();
}

class _EmergencyShowerMaintenancePageState extends State<EmergencyShowerMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load emergency shower maintenance schedule.\n$error",
