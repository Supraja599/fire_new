                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Hero(
                        tag: "hero_image_assets/fire_blankets.webp",
                        child: Image.asset(
                ...
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Fire Blankets Intelligence Hub",
                          style: TextStyle(
                            fontSize: 13.5,
                            fontWeight: FontWeight.w900,
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _ActionCard("Analytics", "assets/dashboard_icons/analytics.webp", const Color(0xFFD32F2F), GenericAnalyticsPage(
                        title: "Fire Blankets Analytics",
                        shortName: "Fire Blankets",
                        assetLabel: "TOTAL FIRE BLANKETS",
                        apiService: api,
                        imagePath: "assets/fire_blankets.webp",
                        fallbackIcon: Icons.analytics_rounded,
                      ), "Trends", _loadData),
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.webp", const Color(0xFFD32F2F), const FireBlanketsInspectionPage(), "Scan", _loadData),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.webp", const Color(0xFFD32F2F), const FireBlanketsMaintenancePage(), "Service", _loadData),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.webp", const Color(0xFFD32F2F), const FireBlanketsAlertsPage(), "Critical", _loadData),
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.webp", const Color(0xFFD32F2F), GenericPlantHealthPage(
                        title: "Fire Blankets Health",
                        shortName: "Fire Blankets",
                        apiService: api,
                        imagePath: "assets/fire_blankets.webp",
                        fallbackIcon: Icons.health_and_safety_rounded,
                      ), "Score", _loadData),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.webp", const Color(0xFFD32F2F), const FireBlanketsReportsPage(), "Logs", _loadData),
                    ],
                  ),
                );
              },
