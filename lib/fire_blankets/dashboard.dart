                  ...
                  const Expanded(
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text("Fire Blankets", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                      ),
                    ),
                  ),
                  Container(
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        FittedBox(
                          fit: BoxFit.scaleDown,
                          child: Text("Emergency Suppression", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900, height: 1.2)),
                        ),
                        SizedBox(height: 12),
                        Text("Central control for blankets.", style: TextStyle(color: Colors.white60, fontSize: 13)),
                      ],
                    ),
                  ),
