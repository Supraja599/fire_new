...
class FireBlanketsChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const FireBlanketsChecklistPage({super.key, this.selectedEquipment});
  @override
  State<FireBlanketsChecklistPage> createState() => _FireBlanketsChecklistPageState();
}

class _FireBlanketsChecklistPageState extends State<FireBlanketsChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Fire Blankets Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
