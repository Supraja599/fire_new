...
class SandBucketPlantHealthPage extends StatefulWidget {
  const SandBucketPlantHealthPage({super.key});
  @override
  State<SandBucketPlantHealthPage> createState() => _SandBucketPlantHealthPageState();
}

class _SandBucketPlantHealthPageState extends State<SandBucketPlantHealthPage> {
  final api = ModuleApiService.sandBucket;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 1, title: const Text("Health Analytics", style: TextStyle(color: Color(0xFFE65100), fontWeight: FontWeight.bold))),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(20),
        child: Column(children: [
          Row(children: [_box("ACTIVE", active, Colors.green, () => _openStatusList("active", "Active Sand Buckets", Colors.green)), const SizedBox(width: 12), _box("SERVICE", service, Colors.orange, () => _openStatusList("needs-service", "Needs Service", Colors.orange))]),
          const SizedBox(height: 12),
          Row(children: [_box("INSPECT", inspect, Colors.blue, () => _openStatusList("due-inspection", "Due Inspection", Colors.blue)), const SizedBox(width: 12), _box("EXPIRED", expired, Colors.red, () => _openStatusList("expired", "Expired Sand Buckets", Colors.red))]),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text("Performance Matrix", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Color(0xFFE65100))),
