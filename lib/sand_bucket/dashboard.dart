...
class SandBucketDashboard extends StatefulWidget {
  const SandBucketDashboard({super.key});

  @override
  State<SandBucketDashboard> createState() => _SandBucketDashboardState();
}

class _SandBucketDashboardState extends State<SandBucketDashboard> {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Hero(
                        tag: "hero_image_assets/sand_bucket.png",
                        child: Image.asset(
                          "assets/sand_bucket.png",
                          width: 130,
                          height: 130,
                          fit: BoxFit.contain,
                        ),
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _ActionCard("Analytics", "assets/dashboard_icons/analytics.webp", const Color(0xFFD32F2F), GenericAnalyticsPage(
                        title: "Sand Bucket Analytics",
                        shortName: "Sand Bucket",
                        assetLabel: "TOTAL SAND BUCKETS",
                        apiService: api,
                        imagePath: "assets/sand_bucket.png",
                        fallbackIcon: Icons.analytics_rounded,
                      ), "Trends", _loadData),
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.webp", const Color(0xFFD32F2F), const SandBucketInspectionPage(), "Scan", _loadData),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.webp", const Color(0xFFD32F2F), const SandBucketMaintenancePage(), "Service", _loadData),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.webp", const Color(0xFFD32F2F), const SandBucketAlertsPage(), "Critical", _loadData),
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.webp", const Color(0xFFD32F2F), GenericPlantHealthPage(
                        title: "Sand Bucket Health",
                        shortName: "Sand Bucket",
                        apiService: api,
                        imagePath: "assets/sand_bucket.png",
                        fallbackIcon: Icons.health_and_safety_rounded,
                      ), "Score", _loadData),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.webp", const Color(0xFFD32F2F), const SandBucketReportsPage(), "Logs", _loadData),
                    ],
                  ),
                );
              },
