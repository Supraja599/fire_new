...
class SandBucketChecklistPage extends StatelessWidget {
  final Map<String, dynamic>? selectedEquipment;
  final bool fromScan;
  const SandBucketChecklistPage({super.key, this.selectedEquipment, this.fromScan = true});
  ...
  static Widget direct() => GuidedCaptureWizardPage(
    ...
    nextScreen: SandBucketChecklistPage(fromScan: false),
  );
  ...
  Widget build(BuildContext context) => GenericChecklistPage(
    ...
    moduleName: 'Sand Bucket',
    primaryColor: const Color(0xFFE65100),
    eventIdPrefix: 'sand_bucket',
    fetchChecklist: () => ModuleApiService.sandBucket.getChecklist(),
  );
}
