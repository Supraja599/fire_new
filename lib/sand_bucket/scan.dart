...
class SandBucketScanPage extends StatefulWidget {
  const SandBucketScanPage({super.key});
  @override
  State<SandBucketScanPage> createState() => _SandBucketScanPageState();
}

class _SandBucketScanPageState extends State<SandBucketScanPage> {
  ...
  void _editDetails() {
    ...
    EditHelper.editDetails(
      context: context,
      item: item!,
      moduleCode: ModuleApiService.sandBucket.moduleCode,
