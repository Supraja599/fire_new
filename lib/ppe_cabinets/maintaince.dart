...
class PPECabinetsMaintenancePage extends StatefulWidget {
  const PPECabinetsMaintenancePage({super.key});

  @override
  State<PPECabinetsMaintenancePage> createState() => _PPECabinetsMaintenancePageState();
}

class _PPECabinetsMaintenancePageState extends State<PPECabinetsMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load ppe cabinets maintenance schedule.\n$error",
