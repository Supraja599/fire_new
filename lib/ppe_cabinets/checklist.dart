...
class PPECabinetsChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const PPECabinetsChecklistPage({super.key, this.selectedEquipment});
  @override
  State<PPECabinetsChecklistPage> createState() => _PPECabinetsChecklistPageState();
}

class _PPECabinetsChecklistPageState extends State<PPECabinetsChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("PPE Cabinets Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
