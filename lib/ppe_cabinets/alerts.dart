...
class PPECabinetsAlertsPage extends StatefulWidget {
  const PPECabinetsAlertsPage({super.key});
  @override
  State<PPECabinetsAlertsPage> createState() => _PPECabinetsAlertsPageState();
}

class _PPECabinetsAlertsPageState extends State<PPECabinetsAlertsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading ? const Center(child: CircularProgressIndicator()) : alerts.isEmpty ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset("assets/ppe_cabinets.png", height: 120, opacity: const AlwaysStoppedAnimation(0.3), errorBuilder: (c,e,s) => Icon(Icons.medical_services, size: 100, color: Colors.grey.shade300)),
