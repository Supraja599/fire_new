                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Hero(
                        tag: "hero_image_assets/ppe_cabinets.webp",
                        child: Image.asset(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _ActionCard("Analytics", "assets/dashboard_icons/analytics.webp", const Color(0xFFD32F2F), GenericAnalyticsPage(
                        title: "Ppe Cabinets Analytics",
                        shortName: "Ppe Cabinets",
                        assetLabel: "TOTAL PPE CABINETS",
                        apiService: api,
                        imagePath: "assets/ppe_cabinets.webp",
                        fallbackIcon: Icons.analytics_rounded,
                      ), "Trends", _loadData),
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.webp", const Color(0xFFD32F2F), const PPECabinetsInspectionPage(), "Scan", _loadData),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.webp", const Color(0xFFD32F2F), const PPECabinetsMaintenancePage(), "Service", _loadData),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.webp", const Color(0xFFD32F2F), const PPECabinetsAlertsPage(), "Critical", _loadData),
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.webp", const Color(0xFFD32F2F), GenericPlantHealthPage(
                        title: "Ppe Cabinets Health",
                        shortName: "Ppe Cabinets",
                        apiService: api,
                        imagePath: "assets/ppe_cabinets.webp",
                        fallbackIcon: Icons.health_and_safety_rounded,
                      ), "Score", _loadData),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.webp", const Color(0xFFD32F2F), const PPECabinetsReportsPage(), "Logs", _loadData),
                    ],
                  ),
                );
              },
