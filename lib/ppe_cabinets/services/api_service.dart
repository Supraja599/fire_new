...
class PPECabinetsApiService {
  static const String baseUrl = "https://ehs.garrev.com/app1/v1";
  static const int moduleId = 49;
  static const String moduleCode = "ppe_station";
  ...
  Future<Map<String, dynamic>> getSummary() =>
      _getAndCacheMap("$baseUrl/modules/$moduleId/summary", "summary");
  Future<List<Map<String, dynamic>>> getEquipmentList() => _getAndCacheList(
    "$baseUrl/equipment?module_id=$moduleId&limit=200",
    "equipment",
  );
  Future<List<Map<String, dynamic>>> getChecklist() =>
      _getAndCacheList("$baseUrl/modules/$moduleId/checklists", "checklist");
  Future<List<Map<String, dynamic>>> getAlerts() =>
      _getAndCacheList("$baseUrl/alerts?module_id=$moduleId", "alerts");
