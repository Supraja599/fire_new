...
class _SmokeDetectorReportsPageState extends State<SmokeDetectorReportsPage> {
  ...
  Future<void> generatePDF() async {
    ...
    try {
      ...
      final file = File("${dir.path}/SmokeDetector_Report_${DateTime.now().millisecondsSinceEpoch}.pdf");
  ...
  Future<void> downloadExcel() async {
    ...
    try {
      ...
      String path = "${dir.path}/SmokeDetector_Report_${DateTime.now().millisecondsSinceEpoch}.xlsx";
      File file = File(path);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Smoke Detector Reports"),
