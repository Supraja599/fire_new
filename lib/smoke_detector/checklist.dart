...
class SmokeDetectorChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const SmokeDetectorChecklistPage({super.key, this.selectedEquipment});

  @override
  State<SmokeDetectorChecklistPage> createState() => _SmokeDetectorChecklistPageState();
}

class _SmokeDetectorChecklistPageState extends State<SmokeDetectorChecklistPage> {
  ...
  Future<void> _saveOffline() async {
    ...
    await LocalDB.queueModuleInspection(
      eventId: "smoke-${DateTime.now().millisecondsSinceEpoch}",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Smoke Detector Checklist", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
