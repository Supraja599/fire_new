    ...
    try {
      ...
      if (mounted && s != null) {
        setState(() {
          ...
          total = s["total"] ?? s["total_units"] ?? (deviceCount + (s["needs_service"] ?? 0) + (s["expired"] ?? 0) + (s["due_inspection"] ?? s["due_inspection_units"] ?? 0));
          summaryData = s;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Hero(
                        tag: "hero_image_assets/smoke_detector.webp",
                        child: Image.asset(
                          "assets/smoke_detector.webp",
                          width: 130,
                ...
                return Padding(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      ...
                      _ActionCard("Inspection", "assets/dashboard_icons/inspection.webp", const Color(0xFFD32F2F), const SmokeDetectorInspectionPage(), "Scan", _loadData),
                      _ActionCard("Maintenance", "assets/dashboard_icons/maintenance.webp", const Color(0xFFD32F2F), const SmokeDetectorMaintenancePage(), "Service", _loadData),
                      _ActionCard("Alerts", "assets/dashboard_icons/alerts.webp", const Color(0xFFD32F2F), const SmokeDetectorAlertsPage(), "Critical", _loadData),
                      _ActionCard("Plant Health", "assets/dashboard_icons/plant_health.webp", const Color(0xFFD32F2F), GenericPlantHealthPage(
                        title: "Smoke Detector Health",
                        shortName: "Smoke Detector",
                        apiService: api,
                        imagePath: "assets/smoke_detector.webp",
                        fallbackIcon: Icons.health_and_safety_rounded,
                      ), "Score", _loadData),
                      _ActionCard("Reports", "assets/dashboard_icons/reports.webp", const Color(0xFFD32F2F), const SmokeDetectorReportsPage(), "Logs", _loadData),
                    ],
                  ),
                );
              },
