        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  const Text("Sprinkler", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                  const Spacer(),
                  Container(
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text("Water Suppression", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900, height: 1.2)),
                        SizedBox(height: 12),
                        Text("Monitoring pressure and valve readiness.", style: TextStyle(color: Colors.white60, fontSize: 13)),
                      ],
                    ),
                  ),
                  const SizedBox(width: 10),
                  Image.asset('assets/sprinkler.png', height: 110, fit: BoxFit.contain, errorBuilder: (c, e, s) => const Icon(Icons.water_drop, color: Colors.white, size: 80)),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  _metricTile("Active Units", isLoading ? "..." : activeUnits.toString().padLeft(2, '0'), Colors.green.shade700),
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  _ActionCard("Plant Health", Icons.health_and_safety_outlined, Colors.green, const SprinklerPlantHealthPage()),
                  _ActionCard("Alerts", Icons.crisis_alert_outlined, Colors.red, const SprinklerAlertsPage()),
                  _ActionCard("Maintenance", Icons.settings_suggest_outlined, Colors.orange, const SprinklerMaintenancePage()),
                  _ActionCard("Reports", Icons.receipt_long_outlined, Colors.purple, const SprinklerReportsPage()),
                  _ActionCard("Checklist", Icons.checklist_rtl_outlined, Colors.blue, const SprinklerChecklistPage()),
                  _ActionCard("Inspection", Icons.center_focus_strong_outlined, Colors.teal, const SprinklerScanPage()),
                ],
              ),
            ),
          ],
