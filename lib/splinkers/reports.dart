...
class _ReportsPageState extends State<ReportsPage> {
  ...
  Future<void> _generatePdf() async {
    ...
    try {
      ...
      final file = File(
        "${dir.path}/Sprinkler_Report_${DateTime.now().millisecondsSinceEpoch}.pdf",
      );
  ...
  Future<void> _downloadExcel() async {
    ...
    try {
      ...
      final dir = Directory('/storage/emulated/0/Download');
      final path =
          "${dir.path}/Sprinkler_Report_${DateTime.now().millisecondsSinceEpoch}.xlsx";
