...
class FireTrolleyPlantHealthPage extends StatefulWidget {
  ...
  @override
  State<FireTrolleyPlantHealthPage> createState() => _FireTrolleyPlantHealthPageState();
}
  ...
  Future<void> _loadData() async {
    try {
      ...
      setState(() {
        ...
        service = summaryData["needs_service"] ?? 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Trolley Health Matrix", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold)),
      ),
      body: isLoading 
        ...
        : SingleChildScrollView(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    _statusBox("ACTIVE", active, Colors.green.shade600, () => _openStatusList("active", "Active Trolleys", Colors.green)),
                    const SizedBox(width: 12),
                    _statusBox("SERVICE", service, Colors.red.shade700, () => _openStatusList("service", "Needs Service", Colors.red)),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 12),
                    _statusBox("EXPIRED", expired, Colors.orange.shade700, () => _openStatusList("expired", "Chemical Expired", Colors.orange)),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text("Operational Analytics", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Colors.blue)),
                      const SizedBox(height: 30),
                      Expanded(
                        child: BarChart(
                          BarChartData(
                            ...
                            barGroups: [
                              ...
                              _bar(1, service, Colors.red.shade400),
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: Image.asset('assets/fire_trolley.png', errorBuilder: (c, e, s) => Icon(Icons.trolley, color: color)),
                    ),
                  ),
