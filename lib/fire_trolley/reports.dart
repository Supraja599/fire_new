...
class _FireTrolleyReportsPageState extends State<FireTrolleyReportsPage> {
  ...
  void initState() {
    super.initState();
    updateDateFields(); _prefillLatestInspection();
  }
  ...
  Future<void> downloadExcel() async {
    ...
    try {
      ...
      final fileName = "FireTrolley_Report_${DateTime.now().millisecondsSinceEpoch}.xlsx";
  ...
  Future<void> _prefillLatestInspection() async {
    try {
      final pendingList = await LocalDB.getPendingModuleInspections(moduleCode: FireTrolleyApiService.moduleCode);
