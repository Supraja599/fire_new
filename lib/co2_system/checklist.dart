...
class CO2SystemChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const CO2SystemChecklistPage({super.key, this.selectedEquipment});
  @override
  State<CO2SystemChecklistPage> createState() => _CO2SystemChecklistPageState();
}

class _CO2SystemChecklistPageState extends State<CO2SystemChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("CO2 System Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
