...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView( // Changed from Column to ListView for stability
          ...
          children: [
            Center(
              child: ConstrainedBox(
                ...
                child: Column(
                  children: [
                    /// ⚪️ MINIMAL HEADER SECTION
                    Container(
                      padding: EdgeInsets.only(top: 25, bottom: 20, left: screenWidth * 0.05, right: screenWidth * 0.05),
                      child: Row(
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: const Icon(Icons.arrow_back_ios_new_rounded, color: Color(0xFFD50000), size: 18),
                                ),
                              ),
                            ),
                          Expanded(
