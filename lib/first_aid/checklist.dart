...
class FirstAidChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const FirstAidChecklistPage({super.key, this.selectedEquipment});
  @override
  State<FirstAidChecklistPage> createState() => _FirstAidChecklistPageState();
}

class _FirstAidChecklistPageState extends State<FirstAidChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("First Aid Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
