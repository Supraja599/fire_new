...
class FirstAidMaintenancePage extends StatefulWidget {
  const FirstAidMaintenancePage({super.key});

  @override
  State<FirstAidMaintenancePage> createState() => _FirstAidMaintenancePageState();
}

class _FirstAidMaintenancePageState extends State<FirstAidMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load first aid maintenance schedule.\n$error",
