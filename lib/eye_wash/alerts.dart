...
class EyeWashAlertsPage extends StatefulWidget {
  const EyeWashAlertsPage({super.key});
  @override
  State<EyeWashAlertsPage> createState() => _EyeWashAlertsPageState();
}

class _EyeWashAlertsPageState extends State<EyeWashAlertsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading ? const Center(child: CircularProgressIndicator()) : alerts.isEmpty ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset("assets/eye_wash.png", height: 120, opacity: const AlwaysStoppedAnimation(0.3), errorBuilder: (c,e,s) => Icon(Icons.medical_services, size: 100, color: Colors.grey.shade300)),
