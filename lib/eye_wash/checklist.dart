...
class EyeWashChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const EyeWashChecklistPage({super.key, this.selectedEquipment});
  @override
  State<EyeWashChecklistPage> createState() => _EyeWashChecklistPageState();
}

class _EyeWashChecklistPageState extends State<EyeWashChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Eye Wash Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
