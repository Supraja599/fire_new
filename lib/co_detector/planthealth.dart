...
class CODetectorPlantHealthPage extends StatefulWidget {
  const CODetectorPlantHealthPage({super.key});
  @override
  State<CODetectorPlantHealthPage> createState() => _CODetectorPlantHealthPageState();
}

class _CODetectorPlantHealthPageState extends State<CODetectorPlantHealthPage> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          Row(children: [_box("ACTIVE", active, Colors.green, () => _openStatusList("active", "Active CO Detectors", Colors.green)), const SizedBox(width: 12), _box("SERVICE", service, Colors.orange, () => _openStatusList("needs-service", "Needs Service", Colors.orange))]),
          const SizedBox(height: 12),
          Row(children: [_box("INSPECT", inspect, Colors.blue, () => _openStatusList("due-inspection", "Due Inspection", Colors.blue)), const SizedBox(width: 12), _box("EXPIRED", expired, Colors.red, () => _openStatusList("expired", "Expired CO Detectors", Colors.red))]),
