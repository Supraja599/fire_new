...
class CODetectorChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const CODetectorChecklistPage({super.key, this.selectedEquipment});
  @override
  State<CODetectorChecklistPage> createState() => _CODetectorChecklistPageState();
}

class _CODetectorChecklistPageState extends State<CODetectorChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("CO Detector Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
