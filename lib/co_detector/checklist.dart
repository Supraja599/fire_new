...
class CODetectorChecklistPage extends StatelessWidget {
  final Map<String, dynamic>? selectedEquipment;
  final bool fromScan;
  const CODetectorChecklistPage({super.key, this.selectedEquipment, this.fromScan = true});
  ...
  Widget build(BuildContext context) => GenericChecklistPage(
    ...
    eventIdPrefix: 'co_detector',
    fetchChecklist: () => ModuleApiService.coDetector.getChecklist(),
  );
}
