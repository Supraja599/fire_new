...
class MusterPointsChecklistPage extends StatefulWidget {
  final Map<String, dynamic>? selectedEquipment;
  const MusterPointsChecklistPage({super.key, this.selectedEquipment});
  @override
  State<MusterPointsChecklistPage> createState() => _MusterPointsChecklistPageState();
}

class _MusterPointsChecklistPageState extends State<MusterPointsChecklistPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Muster Points Checklist"), backgroundColor: Colors.white, foregroundColor: Colors.black, elevation: 1),
