...
class MusterPointsMaintenancePage extends StatefulWidget {
  const MusterPointsMaintenancePage({super.key});

  @override
  State<MusterPointsMaintenancePage> createState() => _MusterPointsMaintenancePageState();
}

class _MusterPointsMaintenancePageState extends State<MusterPointsMaintenancePage> {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Padding(
            ...
            child: Text(
              "Unable to load muster points maintenance schedule.\n$error",
