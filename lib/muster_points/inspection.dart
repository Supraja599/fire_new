...
class _MusterPointsInspectionPageState extends State<MusterPointsInspectionPage> {
  ...
  Future<void> fetchDetails(String input) async {
    ...
    try {
      ...
      if (data == null) {
        setState(() {
          loading = false;
          error = "No Muster Points found for this ID";
          showSearch = true;
        });
        return;
      }
  ...
  Future<void> _submitInspection() async {
    ...
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Muster Points Inspection Saved Locally")));
  }
...
Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Muster Points Inspection", style: TextStyle(fontWeight: FontWeight.bold)),
