...
class MusterPointsReportsPage extends StatefulWidget {
  const MusterPointsReportsPage({super.key});
  @override
  State<MusterPointsReportsPage> createState() => _MusterPointsReportsPageState();
}

class _MusterPointsReportsPageState extends State<MusterPointsReportsPage> {
  ...
  Future<void> generatePDF() async {
    ...
    try {
      ...
      final path = "${directory.path}/muster_points_Report_${DateTime.now().millisecondsSinceEpoch}.pdf";
  ...
  Future<void> generateExcel() async {
    ...
    try {
      ...
      final directory = await getApplicationDocumentsDirectory();
      final path = "${directory.path}/muster_points_Report_${DateTime.now().millisecondsSinceEpoch}.xlsx";
  ...
  Future<void> _prefillLatestInspection() async {
    try {
      final pendingList = await LocalDB.getPendingModuleInspections(moduleCode: MusterPointsApiService.moduleCode);
